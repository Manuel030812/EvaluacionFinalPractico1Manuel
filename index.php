...
<>
    ...
    <br><br><br>
    <div class="headtop">
        <p class="m-0 text-center text-white"> UNIDAD DE COMPETENCIA: <b> Desarrollo de Aplicaciones Web y Móviles</b>
        </p>
    </div>
    <br><br>
	...
	-->
    <!-- Otras etiquetas en tu archivo HTML -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.7.1/jquery.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js"></script>
    <script src="js/login.js"></script> <!-- Incluye tu archivo login.js aquí -->
